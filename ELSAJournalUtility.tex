...
\newenvironment{base_cover_letter}[2]{
    \begin{titlepage}
    \def\paperTitle{#1}
    \def\journalName{#2}
...
\newcommand{\fixgrammar}[1]{\color{\fixgrammarcolor} #1 \color{defaultcolor}}
\newcommand{\revision}[1]{\color{\revisioncolor} #1 \color{defaultcolor}}
\newcommand{\addition}[1]{\color{\additioncolor} #1 \color{defaultcolor}}
\newcommand{\todo}{\color{\todocolor} [TODO] \color{defaultcolor}}
\newcommand{\todotext}[1]{\color{\todocolor} [TODO] [#1] \color{defaultcolor}}
...
\newcommand{\commenter}[1]{
    \section*{\underline{\makebox[\textwidth][l]{#1}}}}

\newenvironment{reviewer_comment}{
    \subsubsection*{\textbf{\textit{\underline{Comments to the Author:}}}}
